					...
					<div class="accordion" id="SpamAnalysisAboutAccordion">
						<div class="accordion-item">
							...
							<div id="col1" class="accordion-collapse collapse"
								...
								<div class="accordion-body">
									<p>
										PostCage integrates with SpamAssassin to provide you with some insight into the
						...
						<div class="accordion-item">
							...
							<div id="col3" class="accordion-collapse collapse"
								...
								<div class="accordion-body">
									<p>
										PostCage does not manipulate the results nor determine the "spamminess" of
