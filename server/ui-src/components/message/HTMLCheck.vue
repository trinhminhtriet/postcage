								...
								<div id="col2" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										<p>
											...
											to matching HTML elements. This gives PostCage fairly accurate results.
										</p>
										<p>
											...
											within CSS blocks. This method is not accurate as PostCage does not know how
							...
							<div class="accordion-item">
								...
								<div id="col3" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										...
										<p>
											For each test, PostCage calculates both the unsupported & partially-supported
										...
										<p>
											PostCage will sort the warnings according to their weighted unsupported
											scores.
										</p>
									</div>
								</div>
