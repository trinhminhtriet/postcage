		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="SettingsModalLabel">PostCage settings</h5>
				...
				<div class="modal-body">
					...
					<div class="tab-content">
						<div class="tab-pane fade show active" id="ui-tab-pane" role="tabpanel" aria-labelledby="ui-tab"
							tabindex="0">
							<div class="my-3">
								<label for="theme" class="form-label">PostCage theme</label>
						...
						<div class="tab-pane fade" id="chaos-tab-pane" role="tabpanel" aria-labelledby="chaos-tab"
							...
							<p class="my-3">
								...
								(<a href="https://postcage.trinhminhtriet.com/docs/integration/chaos/" target="_blank">
									see documentation
								</a>).
							</p>
