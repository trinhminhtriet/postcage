...
<template>
	<template v-if="!modals">
		<div class="bg-body ms-sm-n1 me-sm-n1 py-2 text-muted small about-postcage">
			...
			<button class="btn btn-sm btn-outline-secondary float-end" data-bs-toggle="modal"
				data-bs-target="#SettingsModal" title="PostCage UI settings">
								...
								<div class="row g-3"
									...
									<div class="col">
										<a class="btn btn-warning d-block mb-3"
											:href="'https://github.com/trinhminhtriet/postcage/releases/tag/' + mailbox.appInfo.LatestVersion">
											A new version of PostCage ({{ mailbox.appInfo.LatestVersion }}) is available.
										</a>
									</div>
								</div>
								<div class="row g-3">
									...
									<div class="col-sm-6">
										<a class="btn btn-primary w-100" href="https://github.com/trinhminhtriet/postcage"
											target="_blank">
									...
									<div class="col-sm-6">
										<a class="btn btn-primary w-100" href="https://postcage.trinhminhtriet.com/docs/"
											target="_blank">
											Documentation
										</a>
									</div>
		...
		<div class="modal fade" id="EnableNotificationsModal" tabindex="-1"
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p class="h4">Get browser notifications when PostCage receives new messages?</p>
						<p>
							Note that your browser will ask you for confirmation when you click
							<code>enable notifications</code>,
							and that you must have PostCage open in a browser tab to be able to receive the
							notifications.
						</p>
					</div>
					<div class="modal-footer">
