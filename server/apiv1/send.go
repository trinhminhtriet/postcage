...
type SendRequest struct {
	...
	// Subject
	// example: PostCage message via the HTTP API
	Subject string

	// Message body (text)
	// example: PostCage is awesome!
	Text string

	// Message body (HTML)
	// example: <div style="text-align:center"><p style="font-family: arial; font-size: 24px;">PostCage is <b>awesome</b>!</p><p><img src="cid:postcage-logo" /></p></div>
	HTML string
...
// Send will validate the message structure and attempt to send to PostCage.
