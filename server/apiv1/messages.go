...
func Search(w http.ResponseWriter, r *http.Request) {
	...
	// # Search messages
	//
	// Returns messages matching [a search](https://postcage.trinhminhtriet.com/docs/usage/search-filters/), sorted by received date (descending).
	//
	//	Produces:
	//	  - application/json
	//
...
func DeleteSearch(w http.ResponseWriter, r *http.Request) {
	...
	//
	// Delete all messages matching [a search](https://postcage.trinhminhtriet.com/docs/usage/search-filters/).
	//
	//	Produces:
	//	  - application/json
	//
