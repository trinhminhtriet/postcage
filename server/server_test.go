...
func TestAPIv1Send(t *testing.T) {
	...
	jsonData := `{
		...
		"Subject": "PostCage message via the HTTP API",
		"Text": "This is the text body",
		"HTML": "<p style=\"font-family: arial\">PostCage is <b>awesome</b>!</p>",
		"Attachments": [
		  {
	...
	assertEqual(t, `PostCage message via the HTTP API`, msg.Subject, "wrong subject")
	assertEqual(t, `This is the text body`, msg.Text, "wrong text")
	assertEqual(t, `<p style="font-family: arial">PostCage is <b>awesome</b>!</p>`, msg.HTML, "wrong HTML")
