...
import (
	...
	"github.com/trinhminhtriet/postcage/internal/pop3"
	"github.com/trinhminhtriet/postcage/internal/stats"
	"github.com/trinhminhtriet/postcage/internal/storage"
	"github.com/trinhminhtriet/postcage/internal/tools"
	"github.com/trinhminhtriet/postcage/server/apiv1"
	"github.com/trinhminhtriet/postcage/server/handlers"
	"github.com/trinhminhtriet/postcage/server/websockets"
)
...
func Listen() {
	...
	r.Path(config.Webroot + "postcage.svg").Handler(middleWareFunc(embedController))
...
<body class="h-100">
	<div class="container-fluid h-100 d-flex flex-column" id="app" data-webroot="{{ .Webroot }}" data-version="{{ .Version }}">
		<noscript class="alert alert-warning position-absolute top-50 start-50 translate-middle">
			You need a browser with JavaScript enabled to use PostCage
		</noscript>
	</div>
