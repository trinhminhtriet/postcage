...
import (
	...
	"github.com/trinhminhtriet/postcage/server"
	"github.com/trinhminhtriet/postcage/server/webhook"
)

// rootCmd represents the base command when called without any subcommands
var rootCmd = &cobra.Command{
	Use:   "postcage",
	Short: "PostCage is an email testing tool for developers",
	Long: `PostCage is an email testing tool for developers.

It acts as an SMTP server, and provides a web interface to view all captured emails.

Documentation:
  https://github.com/trinhminhtriet/postcage
  https://postcage.trinhminhtriet.com/docs/`,
...
func init() {
	...
	rootCmd.Flags().StringVar(&config.Label, "label", config.Label, "Optional label identify this PostCage instance")
