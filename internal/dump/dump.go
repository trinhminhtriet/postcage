// Package dump is used to export all messages from postcage into a directory
package dump
...
var (
	...
	// Base URL of postcage instance
	base string

	// URL is the base URL of a remove PostCage instance
	URL string
