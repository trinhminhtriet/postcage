// Package stats stores and returns PostCage statistics
package stats
...
import (
	...
	"github.com/trinhminhtriet/postcage/internal/updater"
)
...
var (
	...
	// StartedAt is set to the current ime when PostCage starts
	startedAt time.Time
...
type AppInformation struct {
	// Current PostCage version
	Version string
	// Latest PostCage version
	...
	// Runtime statistics
	RuntimeStats struct {
		// PostCage server uptime in seconds
		Uptime float64
