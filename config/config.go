...
var (
	...
	// allowing multiple isolated instances of PostCage to share a database.
	TenantID string

	// Label to identify this PostCage instance (optional).
	...
	// @see https://github.com/trinhminhtriet/postcage/issues/87 & https://github.com/trinhminhtriet/postcage/issues/153
	...
	// POP3Listen address - if set then PostCage will start the POP3 server and listen on this address
	POP3Listen = "[::]:1110"
	...
	Repo = "trinhminhtriet/postcage"

	// RepoBinaryName on Github for updater
	RepoBinaryName = "postcage"
...
func VerifyConfig() error {
	...
	// with a random nonce ID to prevent XSS. This applies to the PostCage app & API.
	...
	if Database != "" && isDir(Database) {
		Database = filepath.Join(Database, "postcage.db")
	}
